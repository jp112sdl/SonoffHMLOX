...
void setup() {
  ...
  DEBUG(String(GlobalConfig.DeviceName) + " - Boot abgeschlossen, SSID = " + WiFi.SSID() + ", IP = " + String(WiFi.localIP()) + ", RSSI = " + WiFi.RSSI() + ", MAC = " + WiFi.macAddress(), "setup", _slInformational);
}
